...
export function roomArt(variant = '01'): string {
  const light = variant === '02' ? '#8a8780' : variant === '03' ? '#789899' : variant === '04' ? '#a67b68' : variant === '05' ? '#85826d' : '#b7b8a3';
...
export function caseArt(number: string, large = false): string {
  const art: Record<string, string> = {
    '01': `<path d="M135 105q-20 25-5 63l80 65q36 13 54-9l-32-39-22 13-46-39 10-22z" fill="#858275" stroke="#b3ab8e" stroke-width="2"/><path d="M144 102q38-15 56 7l-15 33-58-24zm91 81 39 27q12 13-9 26l-42-42z" fill="#4a5146"/><path d="M137 119C89 121 83 212 111 244s25 19 37 24" stroke="#767a67" stroke-width="5"/><path d="m301 89-5 159m-62-168 93 4-6 169-81-3" stroke="#526158" stroke-width="2"/><text x="249" y="128" fill="#aeab8c" font-size="18" font-family="monospace">02:13</text>`,
    '02': `<path d="M161 45h150v243H161z" fill="#494b42" stroke="#858371" stroke-width="3"/><path d="M179 61h114v221H179z" stroke="#5e6254" stroke-width="2"/><rect x="201" y="99" width="65" height="34" fill="#958967"/><text x="211" y="124" fill="#242b25" font-size="25" font-family="Georgia">309</text><path d="M184 191h29v6h-29z" fill="#9b9478"/><path d="M309 47h8v241h-8z" fill="#ada787" opacity=".7"/><path d="m317 288 106 37H238z" fill="#b8ab7c" opacity=".13"/>`,
    '03': `<path d="M131 232q9-91 78-99 65 11 72 99" fill="#111e1d"/><ellipse cx="208" cy="111" rx="33" ry="42" fill="#243c38"/><path d="M241 89q54 2 47 69l36 90h-70l-16-69" fill="#627873" opacity=".25"/><path d="M108 71h197v187H108z" stroke="#658079" stroke-dasharray="4 9"/><path d="m113 296 196-201M72 182h270" stroke="#a5b4a1" opacity=".18"/><circle cx="208" cy="156" r="84" stroke="#719089" opacity=".3"/>`,
    '04': `<path d="M218 45v205m-60 0 60-205 60 205M179 177h78M166 222h104" stroke="#a4816e" stroke-width="5"/><path d="m218 68-31 42h62z" fill="#7f5e51"/><circle cx="218" cy="74" r="47" stroke="#c1977e" opacity=".25"/><circle cx="218" cy="74" r="78" stroke="#c1977e" opacity=".12"/><path d="M70 262c53-38 92-38 148 0 56-38 95-38 152 0" stroke="#806c5e" stroke-width="3"/>`,
    '05': `<path d="M70 221h302l-23-123H104z" fill="#343d36" stroke="#92917d" stroke-width="3"/><path d="M124 118h62v59h-69zm92 0h62v59h-62zm92 0h34l11 59h-45z" fill="#1a2925" stroke="#737d6d"/><path d="M95 221h255l24 34H69z" fill="#1c2823"/><circle cx="133" cy="231" r="18" fill="#111915" stroke="#8e8a72" stroke-width="5"/><circle cx="312" cy="231" r="18" fill="#111915" stroke="#8e8a72" stroke-width="5"/><path d="M37 277h366M75 260l-21 40m310-40 21 40" stroke="#a19a7a" stroke-width="4"/>`
  };
  const colors: Record<string, string> = { '01': '#39453b', '02': '#44423a', '03': '#29423f', '04': '#49362f', '05': '#393b32' };
  return `<svg class="case-art ${large ? 'large' : ''}" viewBox="0 0 440 310" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><defs><radialGradient id="case-${number}"><stop stop-color="${colors[number] ?? '#39453b'}"/><stop offset="1" stop-color="#151e1b"/></radialGradient></defs><rect width="440" height="310" fill="url(#case-${number})"/><path d="M0 48h440M0 268h440" stroke="#879582" opacity=".09"/>${art[number] ?? art['01']}<rect width="440" height="310" fill="#081312" opacity=".18"/></svg>`;
}
